...
// Color sólido para barras de gráfica.
const BAR_COLORS: Record<CategoriaGasto, string> = {
  ...
  educacion: "bg-cyan-500",
  otros: "bg-gray-500",
};

export function categoriaBarColor(cat: CategoriaGasto): string {
  return BAR_COLORS[cat];
}
